 ...
 *
 * <p>Note well this is a version adapted from the existing HibernateInterceptor
 * with no support for Hibernate Filters as yet, unlike the Hibernate 3.x versions
 * of Spring's Hibernate Interceptor
 *
...
public class HibernateInterceptorBO implements MethodInterceptor {
