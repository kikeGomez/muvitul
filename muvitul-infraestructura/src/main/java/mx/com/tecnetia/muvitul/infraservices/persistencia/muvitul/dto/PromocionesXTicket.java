 ...
 */
@Entity
@Table(name="promociones_x_ticket"
    ,catalog="muvitul"
)
public class PromocionesXTicket  implements java.io.Serializable {
    ...
    public PromocionesXTicket(PromocionesXTicketId id, Promocion promocion, TicketVenta ticketVenta, int cantidad, BigDecimal importe) {
       this.id = id;
