...
<!-- Custom Theme Style -->
<link href="<c:url value='/resources/css/build/custom.min.css' />"
	rel="stylesheet">
<!-- global project Style -->
<link href="<c:url value='/resources/css/global.css' />" rel="stylesheet">
<!-- fileupload -->
<link
	href="<c:url value='/resources/css/vendors/bootstrap/dist/css/fileinput.css' />"	rel="stylesheet">
	<!-- Select2 -->
<link	href="<c:url value='/resources/css/vendors/select2/dist/css/select2.min.css' />"	rel="stylesheet">
<!-- bootstrap datepicker -->
<link
	href="<c:url value='/resources/js/vendors/datepicker/datepicker3.css' />"	rel="stylesheet">
<!-- Bootstrap time Picker -->
<link
	href="<c:url value='/resources/js/vendors/timepicker/bootstrap-timepicker.min.css' />"	rel="stylesheet">
<!-- Block UI -->
<link
	href="<c:url value='/resources/js/vendors/blockUI/angular-block-ui.min.css' />"	rel="stylesheet">
<!-- Block UI -->
		...
		<div class="main_container">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-cutlery"></i> Dulcer�a/Cafeter�a
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-line-chart"></i>
										Reportes/Estad�sticas <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
								...
								<li><a><i class="fa fa-cogs"></i> Configuraciones <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="#/promocionesTaquilla">Promociones Taquilla</a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									...
									Hern�ndez <span class=" fa fa-angle-down"></span>
							</a>
			...
			<footer>
				...
				<div class="pull-right">
					2017. Grupo Tecnetia SA de CV. <a
						href="http://tecnetia.com.mx/aviso-de-privacidad/" target="_blank">Aviso
						de Privacidad.</a>
				</div>
				<div class="clearfix"></div>
