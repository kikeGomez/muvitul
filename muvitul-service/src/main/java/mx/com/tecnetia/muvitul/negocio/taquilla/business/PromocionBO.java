...
public class PromocionBO {
	...
	public List<PromocionVO> findByCineAndDate(Integer idCine,Integer idPromocionPara,Date fechaExhibicion) throws BusinessGlobalException {
		return PromocionAssembler.getPromocionesVO(promocionDAO.findByCineAndDate(idCine,idPromocionPara,fechaExhibicion));
	}
